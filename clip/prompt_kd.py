...
class CustomCLIP_teacher(nn.Module):
    def __init__(self, cfg, classnames, clip_model):
        ...
        self.VPT_text_trans = Feature_Trans_Module_two_layer(512, 768)
        ...
        self.VPT_text_trans = self.VPT_text_trans.cuda()
        convert_weights(self.VPT_text_trans)
...
class ClipTestTimeTuning(nn.Module):
    ...
    def inference(self, image):
        ...
        stu_image_features, stu_text_features, stu_logits = self.model(image)
        ...
        return tea_logits, stu_logits, loss
